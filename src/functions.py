# An implementation of the Short Time Fourier Transform in TensorFlow
# Original author of this file and helpers.py is Dario Cazzani, but his code was
# in TensorFlow 1.0, so I updated it.
